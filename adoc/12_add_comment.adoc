...
.BlogService.java
----
include::../javasrc/12/src/main/java/gpse/example/domain/BlogService.java[tags=add_comment]
----
...
----
include::../javasrc/12/src/main/java/gpse/example/domain/BlogServiceImpl.java[tags=add_comment]
----
...
.Article.java
----
include::../javasrc/12/src/main/java/gpse/example/domain/Article.java[tags=comments]
----
...
.AddCommentCmd.java
----
include::../javasrc/12/src/main/java/gpse/example/web/AddCommentCmd.java[]
----
...
.BlogController.java
----
include::../javasrc/12/src/main/java/gpse/example/web/BlogController.java[tags=single_article]
----
...
.BlogController.java
----
include::../javasrc/12/src/main/java/gpse/example/web/BlogController.java[tags=add_comment]
----
