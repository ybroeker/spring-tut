...
.Article.java
----
include::../javasrc/6/src/main/java/gpse/example/domain/Article.java[tags=jpa]
----
...
.Comment.java
----
include::../javasrc/6/src/main/java/gpse/example/domain/Comment.java[tags=jpa]
----
...
.User.java
----
include::../javasrc/6/src/main/java/gpse/example/domain/User.java[tags=jpa]
----
<1> Die Klasse ist wieder eine Entität
...
----
include::../javasrc/6/src/main/java/gpse/example/domain/ArticleRepository.java[tags=class]
----
...
----
include::../javasrc/6/src/main/java/gpse/example/ExampleApplication.java[tags=class]
----
...
----
include::../javasrc/6/src/main/java/gpse/example/domain/BlogServiceImpl.java[tags=class]
----
