...
.UserService.java
----
include::../javasrc/9/src/main/java/gpse/example/domain/UserService.java[tags=class]
----
...
.User.java
----
include::../javasrc/9/src/main/java/gpse/example/domain/User.java[tags=addRole]
----
...
----
include::../javasrc/9/src/main/java/gpse/example/domain/UserServiceImpl.java[tags=createUser]
----
...
----
include::../javasrc/9/src/main/java/gpse/example/InitializeDatabase.java[tags=class]
----
