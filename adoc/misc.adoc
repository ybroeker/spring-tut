...
**die groupId sollte um euren Teamnamen/eure Team-Nummer ergänzt werden
** name und artifactID sollten jeweils eine sinnoller Name für euer Projekt sein
* Das Ober-Package (`de.unibi.tdpe.ws2017.example`) sollte passend zu eurer groupId und artifactId angepasst werden
