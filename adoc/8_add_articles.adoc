...
.BlogService.java
----
include::../javasrc/8/src/main/java/gpse/example/domain/BlogService.java[tags=class]
----
...
----
include::../javasrc/8/src/main/java/gpse/example/domain/BlogServiceImpl.java[tags=class]
----
...
.BlogController.java
----
include::../javasrc/8/src/main/java/gpse/example/web/BlogController.java[tags=show_form]
----
...
----
include::../javasrc/8/src/main/java/gpse/example/web/CreateArticleCmd.java[tags=class]
----
...
.BlogController.java
----
include::../javasrc/8/src/main/java/gpse/example/web/BlogController.java[tags=post_form]
----
