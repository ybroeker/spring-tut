...
.BlogController.java
----
include::../javasrc/3/src/main/java/gpse/example/web/BlogController.java[tags=class]
----
...
----
include::../javasrc/3/src/test/java/gpse/example/web/BlogControllerTest.java[tags=test]
----
...
----
include::../javasrc/3/src/it/java/gpse/example/web/BlogControllerIT.java[tags=test]
----
