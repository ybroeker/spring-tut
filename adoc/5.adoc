...
.BlogService.java
----
include::../javasrc/5/src/main/java/gpse/example/domain/BlogService.java[tags=class]
----
...
.BlogController.java
----
include::../javasrc/5/src/main/java/gpse/example/web/BlogController.java[tags=class]
----
...
----
include::../javasrc/5/src/test/java/gpse/example/web/BlogControllerTest.java[tags=test]
----
...
----
include::../javasrc/5/src/main/java/gpse/example/domain/BlogServiceImpl.java[tags=class]
----
