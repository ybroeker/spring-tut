...
.User.java
----
include::../javasrc/7/src/main/java/gpse/example/domain/User.java[tags=class]
----
...
hashen kann man diese z.B. mit https://www.devglan.com/online-tools/bcrypt-hash-generator[^]
...
.UserRepository.java
----
include::../javasrc/7/src/main/java/gpse/example/domain/UserRepository.java[tags=class]
----
...
.UserService.java
----
include::../javasrc/7/src/main/java/gpse/example/domain/UserService.java[tags=class]
----
...
----
include::../javasrc/7/src/main/java/gpse/example/domain/UserServiceImpl.java[tags=class]
----
...
.SecurityConfig.java
----
include::../javasrc/7/src/main/java/gpse/example/SecurityConfig.java[tags=class]
----
