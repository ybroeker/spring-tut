...
.BlogService.java
----
include::../javasrc/11/src/main/java/gpse/example/domain/BlogService.java[tags=class]
----
...
----
include::../javasrc/11/src/main/java/gpse/example/domain/BlogServiceImpl.java[tags=class]
----
...
.BlogController.java
----
include::../javasrc/11/src/main/java/gpse/example/web/BlogController.java[tags=single_article]
----
...
.SecurityConfig.java
----
include::../javasrc/11/src/main/java/gpse/example/SecurityConfig.java[tags=configure]
----
