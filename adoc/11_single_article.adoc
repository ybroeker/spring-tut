...
Die Methode regaiert damit auf Pfade wie z.B. `/articles/0` und `/articles/123`,
...
welches von Thymeleaf zum Formatieren von Daten abgeboten wird.
...
Öffnen wir damit einen, sehen wir den eizelnen Artikel zusammen mit dem Zeitpunkt.
