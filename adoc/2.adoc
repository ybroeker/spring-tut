...
----
include::../javasrc/1/src/main/java/gpse/example/ExampleApplication.java[tags=class]
----
...
----
include::../javasrc/1/src/main/java/gpse/example/WelcomeController.java[tags=class]
----
