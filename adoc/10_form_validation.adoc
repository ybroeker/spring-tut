...
----
include::../javasrc/10/src/main/java/gpse/example/web/CreateArticleCmd.java[tags=validation]
----
...
.BlogController.java
----
include::../javasrc/10/src/main/java/gpse/example/web/BlogController.java[tags=validation]
----
